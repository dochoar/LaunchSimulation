#!/usr/bin/env python3
"""
Test script to verify the launcher functionality with 10 agents using real data.
"""
import sys
import os
...
def create_test_data():
    ...
    agents = [
        SimulatedAgentProfile(
            ...
            current_tools=["Jenkins", "Slack"],
            switching_cost_tolerance=7,
            decision_authority=DecisionAuthority.recommender,
            purchase_urgency=8,
            network_influence=5,
        ...
        SimulatedAgentProfile(
            ...
            current_tools=["Mixpanel", "Excel"],
            switching_cost_tolerance=4,
            decision_authority=DecisionAuthority.decision_maker,
            purchase_urgency=6,
            network_influence=9,
        ...
        SimulatedAgentProfile(
            ...
            current_tools=["AWS Native", "Datadog"],
        ...
        SimulatedAgentProfile(
            ...
            current_tools=["Figma", "Sketch"],
            switching_cost_tolerance=5,
            decision_authority=DecisionAuthority.recommender,
            purchase_urgency=4,
            network_influence=6,
        ...
        SimulatedAgentProfile(
            ...
            current_tools=["Google Analytics"],
            switching_cost_tolerance=8,
...
def test_launcher():
    """Test the launcher node with 10 agents."""
    print("Testing launcher with 10 agents...")
    print("=" * 50)
